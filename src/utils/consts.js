...
export const distribuion = [
  ...
  {
    name: "ООО СП «Промобеспечение»",
    country:
      "Российская Федерация, Московская обл., Сергиево-Посадский г.о., Сергиев Посад г., Московское ш., д. 20А, литер 6Б3, этаж 2, помещ. 3 ",
    phone: " 8 800 101 52 62",
    fax: " 8 926 603 52 62",
    mail: "zakaz@promobesp.ru",
    website: "https://promobesp.ru/",
    region:
...
export const jobsList = [
  ...
  "Ежемесячно предоставляются компенсационные выплаты в размере 50,00 бел. рублей на питание за счет предприятия.",
  "Действует система добровольного страхования медицинских расходов работников, за счет предприятия.",
  "Ежегодно производится единовременная выплата материальной помощи на оздоровление.",
  "Выплата единовременных вознаграждений: к общереспубликанским праздничным дням, профессиональным праздникам, юбилейным датам, 13-ой зарплаты по итогам года.",
  "Обучение или повышение квалификации за счет завода.",
  "Один раз в год выделяются бесплатные путевки в детские оздоровительные лагеря.",
  "Приобретаются новогодние подарки для детей.",
  "Возможность ежегодного оздоровления в санаториях на льготных условиях (оплата до 75% от стоимости путевки Профсоюзом).",
  "Организация различных спортивных мероприятий, абонементы в бассейн (за счет организации).",
  "А также другие социальные гарантии предусмотренные Трудовым законодательством Республики Беларусь.",
];
