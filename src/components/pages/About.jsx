    ...
    <div className="about">
      ...
      <div className="about-container">
        ...
        <div className="about-content">
          ...
          <p>
            В сотрудничестве с Институтом механизации с/х при Академии наук РБ
            завод на постоянной основе осваивает изготовление запасных частей к
            почвообрабатывающей технике, пользующихся стабильным спросом у
            предприятий агропромышленного комплекса РБ. Списочная численность
            работников ОАО "КЗТШ" составила 1246 человек
          </p>
        </div>
      </div>
    </div>
