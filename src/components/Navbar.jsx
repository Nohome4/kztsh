    ...
    <nav className='main-navbar'>
      <ul>
        <li onMouseEnter={handleDropdown} onMouseLeave={handleDropdown}>
          <Link className='Link' to="/about">О заводе</Link>
              {showDropdown &&  <AboutNavbar/>}
        </li>
        <li onMouseEnter={handleDropdownProducts} onMouseLeave={handleDropdownProducts}>
        ...
        <li onMouseEnter={handleDropdownContacts} onMouseLeave={handleDropdownContacts}>
